      ...
      >
        ...
        <div className="experience-item mb-8">
          ...
          <p className="text-gray-600">
            <i className="fas fa-calendar-alt mr-2"></i>June 2024 - July 2024
          </p>
          <p className="text-gray-600">
            Assisted in the development of client websites using HTML, CSS, and
            JavaScript. Worked closely with the design team to ensure the
            websites were responsive and user-friendly.
          </p>
        ...
        <div className="experience-item mb-8">
          ...
          <p className="text-gray-600">
            <i className="fas fa-calendar-alt mr-2"></i>June 2023 - August 2023
          </p>
          <p className="text-gray-600">
            Worked on developing scalable web applications using React and
            Node.js. Improved the performance of existing applications and
        ...
        <div className="experience-item">
          ...
          <p className="text-gray-600">
            <i className="fas fa-calendar-alt mr-2"></i>January 2023 - May 2023
          </p>
          <p className="text-gray-600">
            Implemented machine learning models for predictive analytics and
            worked on data preprocessing and feature engineering for various
            datasets.
          </p>
          <ul className="list-disc list-inside text-gray-600 mt-4">
