    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-4 lg:p-10 bg-gray-100 text-center">
      <section id="intro" className="max-w-4xl lg:ml-64">
        ...
        <p className="text-lg mb-8">
          ...
          challenging environments and consistently deliver innovative solutions. My
          self-driven attitude and quick adaptability make me a valuable asset in any
          project or team.
        </p>
        ...
        <div className="social-links flex justify-center mb-8 space-x-4">
          <a
            ...
            className="text-teal-500 text-3xl hover:text-teal-400"
          >
            <BsLinkedin />
          </a>
          <a
        ...
        <div className="buttons flex flex-col lg:flex-row justify-center space-y-4 lg:space-y-0 lg:space-x-4">
          <a
            href="/about"
            className="bg-teal-500 text-gray-900 py-2 px-4 rounded-md hover:bg-gray-900 hover:text-teal-500 border border-teal-500"
          >
            Read More
          </a>
          <a
